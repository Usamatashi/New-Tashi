...
import { playTransactionRecordedFeedback } from "@/lib/transactionFeedback";
      ...
      <View style={rcStyles.card}>
        ...
        <View style={rcStyles.header}>
          <View style={rcStyles.logoContainer}>
            <Image source={{ uri: logoUri }} style={rcStyles.logo} contentFit="contain" cachePolicy="memory-disk" />
          </View>
...
function SalesmanPayments() {
  ...
  const recordPayment = useMutation({
    ...
    onSuccess: async (_, vars) => {
      ...
      await playTransactionRecordedFeedback();
      if (collectTarget) {
        setShareReceipt({
